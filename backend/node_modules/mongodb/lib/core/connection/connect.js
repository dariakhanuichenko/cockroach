...
const Connection = require('mongodb/lib/core/connection/connection');
const Query = require('mongodb/lib/core/connection/commands').Query;
...
const defaultAuthProviders = require('mongodb/lib/core/auth/defaultAuthProviders').defaultAuthProviders;
