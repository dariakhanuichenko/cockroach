...
const clone = require('mongodb/lib/core/topologies/shared').clone;
const diff = require('mongodb/lib/core/topologies/shared').diff;
const cloneOptions = require('mongodb/lib/core/topologies/shared').cloneOptions;
