...
const ServerType = require('mongodb/lib/core/sdam/server_description').ServerType;
...
const monitoring = require('mongodb/lib/core/sdam/monitoring');
const calculateDurationInMs = require('mongodb/lib/core/utils').calculateDurationInMs;
const MongoTimeoutError = require('mongodb/lib/core/error').MongoTimeoutError;
const Server = require('mongodb/lib/core/sdam/server');
...
const readPreferenceServerSelector = require('mongodb/lib/core/sdam/server_selectors').readPreferenceServerSelector;
const writableServerSelector = require('mongodb/lib/core/sdam/server_selectors').writableServerSelector;
...
const createClientInfo = require('mongodb/lib/core/topologies/shared').createClientInfo;
